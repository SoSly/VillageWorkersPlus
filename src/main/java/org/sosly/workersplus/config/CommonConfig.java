...
public class CommonConfig {
    ...
    private static final ForgeConfigSpec.IntValue PORTER_COST = BUILDER
            .comment("The amount of currency required to hire a porter.")
            .defineInRange("PorterCost", 20, 1, 64);
